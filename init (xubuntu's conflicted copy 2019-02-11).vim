...
let g:buffExplorerAction='ctrlP' " unite,ctrlP,bufexplorer
...
augroup NFind
    autocmd BufRead * if nerdtree#isTreeOpen() | NERDTreeFind | wincmd p | endif
    autocmd BufEnter * if nerdtree#isTreeOpen() | NERDTreeFind  | wincmd p | endif
augroup END

"To disable
"autocmd! NFind BufRead *.go
