...
if !exists("g:calendar_file_type")
    let g:calendar_file_type = "md"
endif
...
function! calendar#diary(day, month, year, week, dir)
  ...
  let sfile = expand(sfile) . "/" . a:day . ".".expand(g:calendar_file_type)
...
function! calendar#sign(day, month, year)
  let sfile = g:calendar_diary."/".a:year."/".a:month."/".a:day.".".expand(g:calendar_file_type)
